    ...
    return (
        <div className="font-sans">
            ...
            <div
                ...
                <h1 className="text-[32px] sm:text-5xl font-bold">Thuê <span
                    className="text-[32px] sm:text-5xl font-bold bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">tài khoản</span> với
                    gói đăng ký phù hợp</h1>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="py-12 md:py-[64px]">
                    ...
                    <div className="text-[14px] leading-[32px] md:text-[20px] md:leading-[42px] font-bold mb-4">Câu hỏi thường gặp</div>
                    {/*faq*/}
                    <div className=" ">
